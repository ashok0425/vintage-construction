...
// Area Chart Example
    ...
    let statisticsGradientFilter = ctx.createLinearGradient(0, 0, 0, 400);
    statisticsGradientFilter.addColorStop(0, "rgba(78, 115, 223, 0.1)");
    statisticsGradientFilter.addColorStop(1, "rgba(78, 115, 223, .001)");
    var myLineChart = new Chart(ctx, {
        ...
        data: {
            ...
            datasets: [{
                label: "Sells ",
                lineTension: 0.3,
                backgroundColor: statisticsGradientFilter,
