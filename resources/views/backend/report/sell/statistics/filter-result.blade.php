	...
	<div class="container-fluid settings-page">
        ...
        <div class="d-flex align-items-center">
            ...
            <div class="btn-group btn-group-sm filter-pdf-btn ms-auto custom-btn-group mb-4" role="group">
                <form action="{{url('report/sell/statistics-pdf')}}" method="get">
                ...
                <form action="{{url('report/sell/statistics-pdf')}}" method="get" target="_blank">
                    @include('backend.report.sell.partial.hidden-filter-value-pdf')
...
@section('js')
    ...
    <script src="{{asset('/backend/js/partial/sale-report-statistics-filter.js')}}"></script>
