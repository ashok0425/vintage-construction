    ...
    <div class="container-fluid">
        ...
        <div class="wiz-card">
            <div class="wiz-card-header">
                <h5 class="wiz-card-title mb-0">Edit Vehicle </h5>
                <div>
            ...
            <div class="wiz-card-body p-4">
                <form action="{{route('vehicle.update',$vehicle)}}" method="post" data-parsley-validate>
                    @method('PATCH')
                    @csrf
                    ...
                    <div>
                        <div class="custom-form-group">
                            ...
                            <input name="name" value="{{old('name',$vehicle->name) }}" id="name" type="text" class="form-control" placeholder="Vehicle Name" required autocomplete="off">
                            @if ($errors->has('name'))
                        ...
                        <div class="custom-form-group">
                            ...
                            <input name="number" value="{{old('number',$vehicle->number) }}" id="name" type="text" class="form-control" placeholder="Vehicle Number" required autocomplete="off">
