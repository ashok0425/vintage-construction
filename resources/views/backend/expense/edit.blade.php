    ...
    <div class="container-fluid">
        <div class="wiz-card">
            <div class="wiz-card-header">
                <h5 class="wiz-card-title mb-0">{{__('pages.update_expense')}}</h5>
                <div>
                        ...
                        <div class="custom-form-group">
                            ...
                            <select name="customer_id" id="customer_id" class="form-select select2-basic">
                                ...
                                @foreach($customers as $customer)
                                    <option value="{{$customer->id}}" {{old('customer_id',$expense->customer_id) == $customer->id ? 'selected' : ''}}>{{$customer->site_name}}</option>
                                @endforeach
                            </select>
