...
@section('content')
    ...
    <div class="container-fluid settings-page">
        ...
        <div class="wiz-box p-lg-4">
            <form action="{{route('save-application-setting')}}" method="post" class="form-horizontal" enctype="multipart/form-data">
                @csrf

                <div class="row g-3">
                    <div class="col-md-4">
                        <div class="form-group">
                            <label for="product_sku_prefix" class="custom-label">{{__('pages.app_name')}} <span class="text-danger">*</span></label>
                            <input name="app_name" type="text" value="{{get_option('app_name')}}" class="form-control" placeholder="Application Name">
                        </div>
                    </div>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input name="address" id="address" type="text" value="{{get_option('address')}}" class="form-control" placeholder="Address">
                        </div>
                    </div>

                    <div class="col-md-4">
                        <div class="form-group">
                            <label for="vat_reg_no" class="custom-label">{{__('pages.vat_reg_number')}} <span class="text-danger">*</span></label>
                            <input name="vat_reg_no" id="vat_reg_no" type="text" value="{{get_option('vat_reg_no')}}" class="form-control" placeholder="{{__('pages.vat_reg_number')}}">
                        </div>
                    </div>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input name="phone" id="phone" type="text" value="{{get_option('phone')}}" class="form-control" placeholder="Phone Number">
                        </div>
                    </div>
                        ...
                        <div class="form-group">
                            ...
                            <select name="default_customer" class="form-control select2">
                                @foreach($customers as $customer)
                                    <option value="{{$customer->id}}" {{get_option('default_customer') == $customer->id ? 'selected' : ''}} >{{$customer->name}}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="app_date_format" class="custom-label">{{__('pages.date_format')}} <span class="text-danger">*</span></label>
                            <select name="app_date_format" class="form-select">
                                <option value="m/d/Y" {{get_option('app_date_format') == 'm/d/Y' ? 'selected' : ''}} > m/d/Y (eg. {{\Carbon\Carbon::now()->format("m/d/Y")}} )</option>
                                <option value="d/m/Y" {{get_option('app_date_format') == 'd/m/Y' ? 'selected' : ''}} > d/m/Y (eg. {{\Carbon\Carbon::now()->format("d/m/Y")}} )</option>
                                <option value="Y/m/d" {{get_option('app_date_format') == 'Y/m/d' ? 'selected' : ''}} > Y/m/d (eg. {{\Carbon\Carbon::now()->format("Y/m/d")}} )</option>
                                <option value="Y/d/m" {{get_option('app_date_format') == 'Y/d/m' ? 'selected' : ''}} > Y/d/m (eg. {{\Carbon\Carbon::now()->format("Y/d/m")}} )</option>
                                <option value="m-d-Y" {{get_option('app_date_format') == 'm-d-Y' ? 'selected' : ''}} > m-d-Y (eg. {{\Carbon\Carbon::now()->format("m-d-Y")}} )</option>
                                <option value="d-m-Y" {{get_option('app_date_format') == 'd-m-Y' ? 'selected' : ''}} > d-m-Y (eg. {{\Carbon\Carbon::now()->format("d-m-Y")}} )</option>
                                <option value="Y-m-d" {{get_option('app_date_format') == 'Y-m-d' ? 'selected' : ''}} > Y-m-d (eg. {{\Carbon\Carbon::now()->format("Y-m-d")}} )</option>
                                <option value="Y-d-m" {{get_option('app_date_format') == 'Y-d-m' ? 'selected' : ''}} > Y-d-m (eg. {{\Carbon\Carbon::now()->format("Y-d-m")}} )</option>
                                ...
                                <option value="M d, Y" {{get_option('app_date_format') == 'M d, Y' ? 'selected' : ''}} > M d, Y (eg. {{\Carbon\Carbon::now()->format("M d, Y")}} )</option>
                                <option value="Y M, d" {{get_option('app_date_format') == 'Y M, d' ? 'selected' : ''}} > Y M, d (eg. {{\Carbon\Carbon::now()->format("Y M, d")}} )</option>
                                <option value="d F, Y" {{get_option('app_date_format') == 'd F, Y' ? 'selected' : ''}} > d F, Y (eg. {{\Carbon\Carbon::now()->format("d F, Y")}} )</option>
                                <option value="Y F, d" {{get_option('app_date_format') == 'Y F, d' ? 'selected' : ''}} > Y F, d (eg. {{\Carbon\Carbon::now()->format("Y F, d")}} )</option>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="app_timezone" class="custom-label">{{__('pages.timezone')}} <span class="text-danger">*</span></label>
                            <select name="app_timezone" class="form-select select2-basic">
                                <option value="{{get_option('app_timezone')}}"> {{get_option('app_timezone')}}</option>
                            ...
                            @if ($errors->has('app_debug'))
                                <div class="error">{{ $errors->first('app_debug') }}</div>
                            @endif
                        </div>
                    </div>
                    ...
                    <div class="col-md-3">
                        <label for="app_logo" class="custom-label">{{__('pages.app_logo')}} <span class="text-danger">*</span></label>
                        <div class="ratio ratio-16x9">
                            <label class="upload-with-preview">
                                <input type="file" name="app_logo" id="app_logo" accept="image/*" class="upload-img-input">
                                @if(get_option('app_logo') != '')
                                    <img src="{{asset(get_option('app_logo'))}}" class="preview-image">
                                @else
                                    <img src="" class="preview-image">
                                @endif
                                <div class="preview-label-text">
                                    <span><i class="bi bi-cloud-arrow-up-fill text-brand-primary fa-2x lh-sm"></i></span>
                                    <span>{{__('pages.app_logo')}}</span>
                    ...
                    <div class="col-md-3">
                        <label for="login_banner" class="custom-label">{{__('Login Banner')}} <span class="text-danger">*</span></label>
                        <div class="ratio ratio-16x9">
                            <label class="upload-with-preview">
                                <input type="file" name="login_banner" id="login_banner" accept="image/*" class="upload-img-input">
                                @if(get_option('login_banner') != '')
                                    <img src="{{asset(get_option('login_banner'))}}" class="preview-image">
                                @else
                                    <img src="" class="preview-image">
                                @endif
                                <div class="preview-label-text">
                    ...
                    <div class="col-md-3">
                        <label for="app_fav_icon" class="custom-label">{{__('pages.app_fav_icon')}} <span class="text-danger">*</span></label>
                        <div class="ratio ratio-16x9">
                            <label class="upload-with-preview">
                                <input type="file" name="app_fav_icon" id="app_fav_icon" accept="image/*" class="upload-img-input">
                                @if(get_option('app_fav_icon') != '')
                                    <img src="{{asset(get_option('app_fav_icon'))}}" class="preview-image">
                                @else
                                    <img src="" class="preview-image">
                                @endif
                                <div class="preview-label-text">
                                    <span><i class="bi bi-cloud-arrow-up-fill text-brand-primary fa-2x lh-sm"></i></span>
                                    <span>{{__('pages.app_fav_icon')}}</span>
                                    <small class="extra-small text-light-muted">Drag & Drop Image Here</small>
                                    <span class="upload-btn">Browse</span>
                                </div>
                            </label>
