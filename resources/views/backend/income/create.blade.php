                ...
                <form action="{{route('income.store')}}" method="post" data-parsley-validate>
                    ...
                    <div>
                        <div class="custom-form-group">
                            ...
                            <input name="expense_date" value="{{old('expense_date') ? old('expense_date') : \Carbon\Carbon::now()->format('Y-m-d')}}" id="expense_date" type="text" data-date-format="yyyy-mm-dd" class="datepicker form-control" placeholder="Income Date" required autocomplete="off">
