                                            ...
                                            <div class="d-flex align-items-center">
                                                <div class="flex-grow-1">
                                                    <div class="input-group input-group-sm">
                                                        ...
                                                        <span class="input-group-text extra-small" id=''>{{ cart.unit ? cart.unit.title.substring(0, 7) : '--'}}</span>
                                                    </div>
                                                </div>
                        ...
                        <div class="px-md-2">
                            <div class="wiz-box p-2">
                                <div class="input-with-icon">
                                    ...
                                    <input type="text" v-model="filter.search" class="form-control form-control-sm" :placeholder="lang.product_search_kye">
                                </div>
                            </div>
                        </div>
                    </div>
